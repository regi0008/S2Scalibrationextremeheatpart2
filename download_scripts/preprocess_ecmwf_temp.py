...
ds_pf = netCDF4.Dataset(dest_dir + "ecmwf_t2m_2016" + init_date + '_pf.nc')
ds_cf = netCDF4.Dataset(dest_dir + "ecmwf_t2m_2016" + init_date + '_cf.nc')
...
for i in range(lead_times):
    ...
    save_netcdf(dest_dir, 'tas', init_date, temp_lon, temp_lat, lead_times, temp_hd, this_weeks_st, 'K', '2 metre temperature', arr_wkly, week_no=i+1, var_number=temp_number)
